...
QT_MOC_LITERAL(4, 29, 15), // "updateTableView"
QT_MOC_LITERAL(5, 45, 8), // "QString&"
QT_MOC_LITERAL(6, 54, 7), // "dateStr"
QT_MOC_LITERAL(7, 62, 14) // "insertTotalRow"

    },
    "TableView\0updateView\0\0column\0"
    "updateTableView\0QString&\0dateStr\0"
    "insertTotalRow"
};
...
void TableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateView((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateTableView((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->insertTotalRow(); break;
        default: ;
        }
    }
}
