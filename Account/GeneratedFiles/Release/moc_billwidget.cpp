...
QT_MOC_LITERAL(4, 41, 10), // "paintEvent"
QT_MOC_LITERAL(5, 52, 12), // "QPaintEvent*"
QT_MOC_LITERAL(6, 65, 23), // "on_calculateBtn_clicked"
QT_MOC_LITERAL(7, 89, 20), // "on_importBtn_clicked"
QT_MOC_LITERAL(8, 110, 20), // "on_deleteBtn_clicked"
QT_MOC_LITERAL(9, 131, 15), // "updateTableView"
QT_MOC_LITERAL(10, 147, 4) // "date"

    },
    "BillWidget\0signal_addData\0\0showTableView\0"
    "paintEvent\0QPaintEvent*\0on_calculateBtn_clicked\0"
    "on_importBtn_clicked\0on_deleteBtn_clicked\0"
    "updateTableView\0date"
};
...
void BillWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->on_importBtn_clicked(); break;
        case 5: _t->on_deleteBtn_clicked(); break;
        case 6: _t->updateTableView((*reinterpret_cast< const QDate(*)>(_a[1]))); break;
        default: ;
        }
